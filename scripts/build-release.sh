...
function usage()
{
    ...
    echo "and generates the checksum files of the marcoin tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/marcoinproject/marcoin.git"
CLONE_DIR="$BUILD_DIRECTORY/marcoin-buildall"
TARGET_DIR="$BUILD_DIRECTORY/marcoin-releases"
DYNAMIC_RELEASE="marcoin-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="marcoin-${TAG_VERSION}-linux-staticboost-CLI"
