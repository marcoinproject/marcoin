# USAGE: Start marcoin-service as you usually would
...
from marcoin import Walletd as Wallet
import time
import argparse
parser = argparse.ArgumentParser()
parser.add_argument("--address", help="marcoin address to optimize", required=True)
