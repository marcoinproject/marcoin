...
#define CN_MARCOIN_PAGE_SIZE             262144
#define CN_MARCOIN_SCRATCHPAD            262144
#define CN_MARCOIN_ITERATIONS            131072
...
#include "hash-ops.h"
  ...
  */
  ...
  inline void cn_marcoin_slow_hash_v1(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 0, 1, 0, CN_MARCOIN_PAGE_SIZE, CN_MARCOIN_SCRATCHPAD, CN_MARCOIN_ITERATIONS);
  }

  inline void cn_marcoin_slow_hash_v2(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 0, 2, 0, CN_MARCOIN_PAGE_SIZE, CN_MARCOIN_SCRATCHPAD, CN_MARCOIN_ITERATIONS);
  }

  // Standard CryptoNight Marcoin Lite
  inline void cn_marcoin_lite_slow_hash_v0(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 1, 0, 0, CN_MARCOIN_PAGE_SIZE, CN_MARCOIN_SCRATCHPAD, CN_MARCOIN_ITERATIONS);
  }

  inline void cn_marcoin_lite_slow_hash_v1(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 1, 1, 0, CN_MARCOIN_PAGE_SIZE, CN_MARCOIN_SCRATCHPAD, CN_MARCOIN_ITERATIONS);
  }

  inline void cn_marcoin_lite_slow_hash_v2(const void *data, size_t length, Hash &hash) {
    cn_slow_hash(data, length, reinterpret_cast<char *>(&hash), 1, 2, 0, CN_MARCOIN_PAGE_SIZE, CN_MARCOIN_SCRATCHPAD, CN_MARCOIN_ITERATIONS);
  }
