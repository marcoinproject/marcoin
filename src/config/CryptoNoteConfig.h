...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 8943;
...
const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX                 = 5000;
const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX_V2              = 10000;
const uint64_t LWMA_2_DIFFICULTY_BLOCK_INDEX_V3              = 300000;
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "011e01ff000180a99602020334c839ca2aaeaba7b13a5f81d5a3846ab336cfccab1cfb9511741f18c7c13f21013df5c1a0f54d09531ea6b3374206ef244a3d85134177276ef31bc676c1070ad8";
static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in marcoind. It is used to know what timestamp
...
const uint32_t MIXIN_LIMITS_V1_HEIGHT                        = 17500;
const uint32_t MIXIN_LIMITS_V2_HEIGHT                        = 44000;
const uint32_t MIXIN_LIMITS_V3_HEIGHT                        = 300000;

/* The mixin to use by default with zedwallet and marcoin-service */
...
const uint32_t UPGRADE_HEIGHT_V4                             = 17500; // Upgrade height for CN-Lite Variant 1 switch.
const uint32_t UPGRADE_HEIGHT_V5                             = 44000; // Upgrade height for CN-marcoin Variant 2 switch.
...
const char     CRYPTONOTE_NAME[]                             = "Marcoin";
...
const int      P2P_DEFAULT_PORT                              =  8606;
const int      RPC_DEFAULT_PORT                              =  8607;
...
const char     LATEST_VERSION_URL[]                          = "http://www.marcoinproject.com";
const std::string LICENSE_URL                                = "https://github.com/marcoinproject/marcoin/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0x11, 0x11, 0x10, 0x10, 0x10, 0x01, 0x01, 0x21, 0x10, 0x11, 0x02, 0x12, 0x10, 0x21, 0x21, 0x20  }
};
