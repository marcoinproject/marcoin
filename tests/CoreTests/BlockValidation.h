...
public:
  CheckBlockPurged(size_t invalidBlockIdx, uint8_t blockMajorVersion) :
    ...
    assert(blockMajorVersion == BLOCK_MAJOR_VERSION_1 || blockMajorVersion == BLOCK_MAJOR_VERSION_2);

    CryptoNote::CurrencyBuilder currencyBuilder(m_logger);
    currencyBuilder.upgradeHeightV2(blockMajorVersion == BLOCK_MAJOR_VERSION_1 ? CryptoNote::IUpgradeDetector::UNDEF_HEIGHT : UINT32_C(0));
...
struct TestMaxSizeOfParentBlock : public CheckBlockAccepted {
  TestMaxSizeOfParentBlock() : CheckBlockAccepted(2, BLOCK_MAJOR_VERSION_2) {
  }
...
struct TestBigParentBlock : public CheckBlockPurged {
  TestBigParentBlock() : CheckBlockPurged(1, BLOCK_MAJOR_VERSION_2) {
  }
...
struct TestBlock2ExtraEmpty : public CheckBlockPurged {
  ...
  TestBlock2ExtraEmpty() : CheckBlockPurged(1, BLOCK_MAJOR_VERSION_2) {}
...
struct TestBlock2ExtraWithoutMMTag : public CheckBlockPurged {
  ...
  TestBlock2ExtraWithoutMMTag() : CheckBlockPurged(1, BLOCK_MAJOR_VERSION_2) {}
...
struct TestBlock2ExtraWithGarbage : public CheckBlockAccepted {
  ...
  TestBlock2ExtraWithGarbage() : CheckBlockAccepted(2, BLOCK_MAJOR_VERSION_2) {}
