...
TEST_F(BlockchainExplorerTests, getRewardBlocksWindow) {
  ASSERT_EQ(blockchainExplorer.getRewardBlocksWindow(), CRYPTONOTE_REWARD_BLOCKS_WINDOW);
}
...
TEST_F(BlockchainExplorerTests, getFullRewardMaxBlockSize) {
  ASSERT_EQ(blockchainExplorer.getFullRewardMaxBlockSize(1), CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_V1);
  ASSERT_EQ(blockchainExplorer.getFullRewardMaxBlockSize(2), CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_V2);
  ASSERT_EQ(blockchainExplorer.getFullRewardMaxBlockSize(3), CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE);
}
